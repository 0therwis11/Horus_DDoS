...
sys.stdout.write("\x1b]2;Katana Made By 0therwis1\x07")
def modifications():
	print ("Contact 0therwis1 The Script Is Currently Under Maitnance.")
...
info = """
wis3ly Was Created By 0therwis1.
...
║══════════════════════════════════════════════════════║
║ \033[00m[*] Username And Password Changed To "0therwis1".\033[91m    ║
...
║ \033[00m[*] To Be A root Type "root" For User And Pass.\033[91m      ║
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;wis3ly Made By 0therwis1\x07")
		sin = input("\033[1;00m[\033[91mwis3ly\033[1;00m]# ").lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
			...
			print ("\n[\033[91mwis3ly\033[00m] Total Attacks: {}\n".format (aid))
			main()
		elif sinput == "resolve":
			liips += 1
			host = sin.split(" ")[1]
			host_ip = socket.gethostbyname(host)
			print ("[\033[91mwis3ly\033[00m] Host: {} \033[00m[\033[91mConverted\033[00m] {}".format (host, host_ip))
			main()
		elif sinput == "ping":
			tpings += 1
			try:
				sinput, host, port = sin.split(" ")
				print ("[\033[91mwis3ly\033[00m] Starting Ping On Host: {}".format (host))
				try:
					ip = socket.gethostbyname(host)
				except socket.gaierror:
					print ("[\033[91mwis3ly\033[00m] Host Un-Resolvable.")
					main()
				while True:
					try:
						sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
						...
						sys.stdout.write("\x1b]2;W I S 3 L Y [()ms] S O U L S\x07".format (stop))
						print ("wis3ly: {}:{} | Time: {}ms [\033[91mUP\033[00m]".format(ip, port, stop))
						sock.close()
						time.sleep(1)
					except socket.error:
						sys.stdout.write("\x1b]2;W I S 3 L Y |TIME OUT| S O U L S\x07")
						print ("wis3ly: {}:{} [\033[91mDOWN\033[00m]".format(ip, port))
						time.sleep(1)
					except KeyboardInterrupt:
						print("")
						main()
			except ValueError:
				print ("[\033[91mwis3ly\033[00m] The Command {} Requires An Argument.".format (sinput))
				main()
		elif sinput == "udp":
			if username == "guests":
				print ("[\033[91mwis3ly\033[00m] You Are Not Allowed To Use This Method.")
				main()
			else:
				try:
					...
					print ("[\033[91mwis3ly\033[00m] Host: {} Invalid".format (host))
					main()
		elif sinput == "http":
			try:
				sinput, host, port, timer, pack = sin.split(" ")
			...
			if what == "udp":
				...
				while not udp:
					if aid == 0:
						print ("[\033[91mwis3ly\033[00m] No UDP Processes Running.")
						udp = True
						main()
			if what == "icmp":
				...
				icmp = False
				while not icmp:
					print ("[\033[91mwis3ly\033[00m] No ICMP Processes Running.")
					udp = True
					main()
		else:
			print ("[\033[91mwis3ly\033[00m] {} Is Not A Command.".format(sinput))
			main()



try:
	users = ["0therwis1", "root" , ]
	clear = "clear"
	os.system (clear)
	...
	if user == "0therwis1":
		if password == passwords[0]:
			...
			try:
				...
				print ("\n[\033[91mwis3ly\033[00m] Ctrl-C Has Been Pressed.")
				main()
		else:
			print ("[*] Incorrect, Exiting.")
			exit()
